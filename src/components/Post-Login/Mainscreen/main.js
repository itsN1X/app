...
var Notification =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/new/notification.png";
var Background =
...
export default class Main extends Component {
  ...
  sendCoins() {
    ...
    BackHandler.removeEventListener("hardwareBackPress", this.handleBackButton);
    Actions.send({
      utxo: self.state.utxo,
      fromAddress: self.state.address,
  ...
  openTransactions() {
    BackHandler.removeEventListener("hardwareBackPress", this.handleBackButton);
    Actions.fulltransactionhistory({
    ...
    try {
      ...
      axios({
        ...
        .then(function(response) {
          ...
          self.setState({
            address: coinData[0].address,
            privateKey: coinData[0].privateKey,
            balance: balance,
            receiving: false,
            loaded: true,
            transactions: response.data.transactions,
            receiving: false,
            utxo: response.data.balanceHistory.utxo,
            loaded: true
          });
        })
        ...
        <Animated.View style={{ flex: 1 }}>
          ...
          <View style={styles.lowerflex}>
            <View style={styles.sendRecieve}>
              <TouchableOpacity
                onPress={this.receiveCoins}
                style={styles.recieveButtonContainer}
              >
