...
var ExchangeIcon =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/exchangedark.png";
...
export default class Exchange extends React.Component {
  ...
  interchangeCoins() {
    ...
    this.setState({
      pickerToValue: temp,
      pickerFromValue: this.state.pickerToValue,
            ...
            <View style={styles.upperFlex}>
              ...
              <View style={styles.exchangeContainer}>
                <View style={styles.coinsContainer}>
                  <TouchableOpacity
                    style={styles.leftCoinContainer}
                    onPress={() => this.enablePicker("from")}
                  >
                    <Text style={styles.coinText}>
                      {this.state.pickerFromValue}
                    </Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    style={styles.rightCoinContainer}
                    onPress={() => this.enablePicker("to")}
                  >
                    <Text style={styles.coinText}>
                      {this.state.pickerToValue}
                    </Text>
                  </TouchableOpacity>
                </View>
                <View style={styles.noteContainer}>
                  <Text style={styles.noteText}>
                    Tap to change the currency
                  </Text>
                </View>
              </View>
            </View>
            <View style={styles.lowerFlex}>
              <View style={styles.instantRateFlex}>
                <View style={styles.instantRateHeadingContainer}>
                  <Text style={styles.instantRateHeadingText}>
                    INSTANT RATE
                  </Text>
                </View>
                <View style={styles.instantRateContainer}>
                  <Text style={styles.instantRateText}>
                    1 {this.state.pickerFromValue} = {this.state.rate}{" "}
                    {this.state.pickerToValue}
                  </Text>
                </View>
              </View>
              <View style={styles.spendableFlex}>
                ...
                <View style={styles.spendableContainer}>
                  <Text style={styles.spendableText}>
                    {this.state.spendable} {this.state.pickerFromValue}
                  </Text>
                </View>
              </View>
