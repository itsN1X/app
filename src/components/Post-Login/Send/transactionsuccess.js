                            ...
                            <View style={styles.lowerCard}>
                                <View style={styles.cardContent}>
                                    ...
                                    <View style={styles.contentTextContainer}>
                                        ...
                                        <TouchableOpacity onPress={this.writeToClipboard} style={{flex: 0.1, justifyContent: 'center', alignItems: 'center'}}>
                                ...
                                <View style={styles.cardContent}>
                                    ...
                                    <View style={styles.contentTextContainer}>
                                        <Text style={styles.contentText}>{Math.abs(this.state.response.result.details[0].amount)} BTC</Text>
                                    </View>
                                </View>
                                <View style={styles.buttonContainer}>
                                    <TouchableOpacity style={styles.button} onPress={this.gotoMainScreen}>
