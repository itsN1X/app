  ...
  render() {
    ...
    return (
      <View style={styles.walletItemContainer}>
        <TouchableOpacity
          style={[styles.walletItem, { backgroundColor: bgColor }]}
        ...
        >
          <View style={styles.upperFlex}>
            ...
            <View style={styles.coinNameContainer}>
              <Text style={[styles.coinNameText, { color: textColor }]}>
                {this.props.name == "Bitcoin"
                  ? this.props.name.toUpperCase()
                  : this.props.name.toUpperCase() + " (coming soon)"}
              </Text>
            </View>
          </View>
          <View style={styles.lowerFlex}>
            <View style={{ flex: 0.11 }} />
            <Text style={[styles.coinPriceText, { color: textColor }]}>
              1 {this.props.symbol} = {this.props.value} {this.props.currency}
            </Text>
          </View>
          {this.state.selected ? (
