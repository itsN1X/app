	...
	render() {
		return (
			<View style={styles.container}>
				<StatusBar />
				<AppStatusBar left={true} Back={Back} leftFunction={this.goBack} center={true} text="Add New Address" />
				...
				<View style={styles.noteFlex}>
					...
					<View style={styles.noteTextContainer}>
						<Text style={styles.noteText}>Note: Please enter a unique name</Text>
					</View>
				</View>
