...
import { StyleSheet, Text, View, Image, ActivityIndicator, TextInput, ScrollView, TouchableOpacity, Dimensions, KeyboardAvoidingView } from 'react-native';
	...
	render() {
		return (
			<View style={styles.container}>
				<StatusBar />
				<AppStatusBar left={true} Back={Back} leftFunction={this.goBack} center={true} text="Addresses" />
				...
				<View style={styles.addressesContentFlex}>
					<ScrollView style={{flex: 1}}>
						...
						<AddressItem addressType="Business Address" selected={this.state.two} />
						<AddressItem addressType="Personal Address" selected={this.state.three} />
						<AddressItem addressType="Other Address" selected={this.state.four} />
					</ScrollView>
				</View>
