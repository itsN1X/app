...
var Profile = "https://s3.ap-south-1.amazonaws.com/maxwallet-images/profile.png";
var Exchange = "https://s3.ap-south-1.amazonaws.com/maxwallet-images/sendrecieve.png";
var Settings = "https://s3.ap-south-1.amazonaws.com/maxwallet-images/settings.png";
var BackupPhrase = "https://s3.ap-south-1.amazonaws.com/maxwallet-images/padlock.png";
		...
		return (
			<View style={styles.container}>
				...
				<View style={styles.menuItemsFlex}>
					...
					<MenuItem iconImage={Profile} itemName="Profile" itemFunction={this.onProfilePress} />
					<MenuItem iconImage={Shield} itemName="Setup Recovery" itemFunction={this.onKeyRecoveryPress} />
					<MenuItem iconImage={Exchange} itemName="Exchange" itemFunction={this.onExchangePress} />
					<MenuItem iconImage={BackupPhrase} itemName="Backup Phrase" itemFunction={this.onBackupPhrasePress} />
					{/*this.props.mainDrawer ? <MenuItem iconImage={Wallet} itemName="Wallets" itemFunction={this.onWalletsPress} /> : null*/}
					<MenuItem iconImage={Settings} itemName="Settings" itemFunction={this.onSettingsPress} />
				</View>
