          ...
          <ScrollView style={{ height: "100%", width: "100%" }}>
            ...
            >
              ...
              {this.state.viewKeys === "false" ? null : (
                <TouchableOpacity
                  style={styles.otherTabFlex}
                  onPress={this.gotoViewKeys}
                >
              ...
              <TouchableOpacity
                style={styles.otherTabFlex}
                onPress={this.promptUserForLogout}
              >
                <View style={styles.otherTabContainer}>
                  <View
                    style={[styles.tabHeadingFlex, { alignItems: "center" }]}
                  >
                    <Text
                      style={[
                        styles.tabheadingText,
                        { color: theme.netflixred }
                      ]}
                    >
                      Logout
                    </Text>
