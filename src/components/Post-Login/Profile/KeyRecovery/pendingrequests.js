...
var guardian =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/new/gaurdian-man.png";
var Unconfirmed =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/new/reject.png";
var Confirmed =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/new/accept.png";
var Protected =
...
export default class PendingRequests extends React.Component {
      ...
      axios({
        ...
        .then(function(response) {
          ...
          if (
            ...
            response.data.recoveryData.length === 0
          ) {
  ...
  decryptTrustData(data, account) {
    ...
    for (i = 0; i < data.trustData.length; i++) {
      decryptedTrustData[i] = this.decryptData(
        data.trustData[i].trust_data,
        account.privateKey
      );
    }
    this.checkRequests(
    ...
    for (i = 0; i < recoveryData.length; i++) {
      for (j = 0; j < trustData.length; j++) {
        if (trustData[j].user_public_key === recoveryData[i].from_public_key) {
          ...
          data.secret = this.encryptData(
            trustData[j].secret,
            recoveryData[i].new_public_key
          );
        ...
        <View style={styles.container}>
          ...
          {this.props.back ? (
            <AppStatusBar
              ...
              center={true}
              text={this.state.pendingRequestsTitle}
          ...
          <ScrollView style={styles.scrollView}>
                  ...
                  return (
                    ...
                    >
                      <RequestItem
                        ...
                        from_public_key={value.from_public_key}
            ...
            {this.state.requestList.length == 0 ? (
              ...
              >
                ...
                >
                  Share your username to become a trusted device.
                </Text>
                  ...
                  <Button
                    ...
                    onPress={() =>
                      this.copyToClipboard(
                        this.state.pendingRequestsTitle.replace("@", "")
                      )
                    }
                  >
                    <Text>Copy Username</Text>
                  </Button>
                  {this.state.iphoneX && <View style={{ height: 30 }} />}
                </View>
              </View>
            ) : null}
          </ScrollView>
