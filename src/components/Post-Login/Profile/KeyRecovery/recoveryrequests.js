...
var FloatingRefresh =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/float_refresh.png";
var backCount = 0;
  ...
  recoverMnemonic() {
    this.setState({ loaded: false }, () => {
      requestAnimationFrame(() => {
        Actions.showmnemonic({
          publicKey: this.state.oldPublicKey,
          privateKey: this.state.newPrivateKey,
              ...
              {this.state.requestList.map((value, i) => {
                return (
                  <RecoveryRequestItem
                    ...
                    user_public_key={value.friendsHandle}
                    status={value.trust_status}
                  />
                );
              })}
            </View>
