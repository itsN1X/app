...
let bgImage =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/coinsafeBg.png";
let logoImage =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/logoLight.png";
var backCount = 0;
          ...
          <ImageBackground style={styles.bgImage} source={{ uri: bgImage }}>
            ...
            <View style={styles.buttonsFlex}>
              ...
              <View style={styles.guardianContainer}>
                <TouchableOpacity
                  style={styles.guardianTouch}
                  onPress={this.gotoGuardianView}
                >
                  <Text style={styles.guardianText}>
                    BECOME A TRUSTED DEVICE
                  </Text>
                </TouchableOpacity>
              </View>
            </View>
