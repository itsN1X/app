...
export default class Verification extends React.Component {
  ...
  onConfirm() {
    ...
    if (
      this.state.mnemonicArray[this.state.rand1 - 1] === word1 &&
      this.state.mnemonicArray[this.state.rand2 - 1] === word2
    ) {
      ...
      return (
        <TouchableWithoutFeedback onPress={this.onUnfocus}>
          <View style={styles.container}>
            ...
            <AppStatusBar
              left={true}
              Back="https://s3.ap-south-1.amazonaws.com/maxwallet-images/darkback.png"
