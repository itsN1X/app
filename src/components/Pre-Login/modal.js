...
const close =
  "https://s3.ap-south-1.amazonaws.com/maxwallet-images/new/close.png";
            ...
            <View style={styles.wrap}>
              <View style={styles.uppermodalflex}>
                <View>
                  ...
                  <Text style={{ fontFamily: theme.font500, fontSize: 20 }}>
                    100 BTC
                  </Text>
                </View>
                <View>
              ...
              <View style={styles.lowermodalflex}>
                ...
                >
                  <View>
                    ...
                    <Text style={{ fontFamily: theme.font500, fontSize: 16 }}>
                      100 BTC
                    </Text>
                  </View>
                  <View>
                ...
                <View>
                  <View>
                    <Text style={{ fontFamily: theme.font, fontSize: 12 }}>
                      To
                    </Text>
                    <Text
                      style={{
                  ...
                  <View>
                    ...
                    >
                      98s7fg9fd7g98df79df8vyhefsgydf9byhdfbuf
                    </Text>
                  </View>
                </View>
              </View>
