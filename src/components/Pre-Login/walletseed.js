			...
			<View style={styles.container}>
				...
				<View style={styles.textFlex}>
					...
					<View style={styles.secondaryTextContainer}>
						<Text style={styles.secondaryText}>Write down your seed somewhere very safe.</Text>
					</View>
				</View>
				<View style={styles.seedFlex}>
					<View style={styles.seedContainer}>
						...
						<TouchableOpacity style={styles.copyButton} onPress={this.writeToClipboard}>
							<Image style={styles.copyIcon} source={{uri: "https://s3.ap-south-1.amazonaws.com/maxwallet-images/copy.png"}} />
						</TouchableOpacity>
					</View>
				</View>
				<View style={{flex: 0.2}} />
				<View style={styles.buttonsFlex}>
					<View style={styles.walletButtonContainer}>
						<Button bColor = {theme.dark} onPress={this.seedVerification}>
							<Text style={styles.createWalletText}>Yes, I have the seed with me</Text>
						</Button>
					</View>
				</View>
			</View>
